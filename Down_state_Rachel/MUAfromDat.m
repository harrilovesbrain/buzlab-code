...
sessionInfo = bz_getSession('basepath', basePath);

datSampleRate = sessionInfo.extracellular.sr;

lfpSampleRate = sessionInfo.extracellular.srLfp;
...
for ii = 1:length(channels)
    ...
    datlfp.data = bz_LoadBinary(datfilename,...
        'frequency',datSampleRate,'nchannels',sessionInfo.extracellular.nChannels,...
